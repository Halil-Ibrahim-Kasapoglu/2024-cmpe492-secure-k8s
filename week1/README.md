...
- We have conducted load tests on both the VM-based Apache server and the Kubernetes-deployed Apache server with HPA enabled. We have provided our test results in the [results](results) directory. The results include the output of the ab load tests. 
